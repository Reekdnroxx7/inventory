	 ...
	 _appendHTML: function($this,value) {
		 ...
		 var html = '',
			 ...
			 if($('.js-max-input',$parent).length == 0) {
				html += '<div class="js-max-input" sytle="border: solid 1px #ffd2b2;background: #fffae5;padding: 0 10px 0 10px;font-size:20px;color: #ff4400"></div>';
				$($parent).append(html);
			 }
