...
CodegField.entityName = new Ext.form.field.Text({
	fieldLabel : '类名:',
	width : 500,
	allowBlank : false,
	id : 'entityName',
...
CodegField.formPanel = Ext.create('Ext.form.Panel', {
	standardSubmit:true,
			bodyPadding : 10,
			items : [CodegField.basePkg,CodegField.module,CodegField.pkg,CodegField.description,CodegField.entityName ]
		});
CodegField.gridWin = Ext.create('Ext.window.Window', {
			...
			showRecord : function(record) {
				...
				if(record.data.entityName){
					CodegField.entityName.setValue(record.data.entityName);
				}
