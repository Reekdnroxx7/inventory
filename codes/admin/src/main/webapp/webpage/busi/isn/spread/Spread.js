    ...
    columns: [
        ...
        },
        {
            ...
            renderer: function (value, meta, rec) {
                return "上盘口:" +rec.get("homeSpread").marketSelectionId + "<br/>" + "下盘口:" + rec.get("awaySpread").marketSelectionId;
            },
            width: 200
        },
        {
...
var sock;
function createWs() {
    sock = new WebSocket("ws://" + localObj.host + "/springws/isn.ws");
    ...
    sock.onmessage = function (event) {
        ...
        for (var i = 0; i < array.length; i++) {
            var rec = array[i];
            var spread = Ext.create("IsnSpread", rec);
