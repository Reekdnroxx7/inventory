...
public class MybatisServiceGenerator extends AbstractCodeGenerator
{
    String templateFileName = "codeg/mybatis/ServiceTemplate.ftl";
    ...
    protected File getOutputFile(Map<String, Object> data) throws IOException {
        ...
        return new File(dir, entityName + "Service.java");
    }
