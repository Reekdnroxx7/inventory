package com.x404.admin.core.hibernate.dao.impl;
...
import com.x404.admin.core.util.Reflections;
...
//	}
     ...
     */
    @SuppressWarnings("unchecked")
    public ExPageList<T> getPageList(final HibernateQuery cq, final ExPageList<T> page) {
