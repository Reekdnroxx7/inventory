...
public class MybatisEntityGenerator extends AbstractCodeGenerator
{
    String templateFileName = "codeg/mybatis/EntityTemplate.ftl";
    ...
    protected File getOutputFile(Map<String, Object> data) throws IOException {
        ...
        return new File(dir, entityName + ".java");
    }
