package com.x404.admin.manage.codeg.restful;
...
public class RestCtlGenerator extends AbstractCodeGenerator
{
    String templateFileName = "codeg/restful/CtlTemplate.ftl";
