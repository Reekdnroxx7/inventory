package com.x404.beat.core.query;
...
public class HibernateQueryHelper {
    ...
    protected static HibernateQuery generateFromRequest(Map<String, Object> requestMap, Map<String, PropertyDescriptor> propertyDescriptors) {
