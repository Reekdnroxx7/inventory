package com.x404.module.basedao.mongo.query;

import com.xc350.web.base.query.QueryField;
import com.xc350.web.base.query.QueryFieldOP;
...
public class MongoQueryHelper {
    ...
    protected static Query generateFromRequest(HttpServletRequest request, Map<String, PropertyDescriptor> propertyDescriptors) {
        ...
        if (StringUtils.hasText(orderBy)) {
            ...
            OrderBySource orderBySource = new OrderBySource(orderBy);
